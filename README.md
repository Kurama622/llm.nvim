...
| split       | Output:Ask        | Open the input box<br>In the normal mode of the input box,<br>press Enter to submit your question) | `[n] i`                  | Output                                       |
...
| float       | Focus:Input       | Jump from the output window<br>to the input window                                               | -                        | Output                                       |
| float       | Focus:Output      | Jump from the input window<br>to the output window                                               | -                        | Input                                        |
